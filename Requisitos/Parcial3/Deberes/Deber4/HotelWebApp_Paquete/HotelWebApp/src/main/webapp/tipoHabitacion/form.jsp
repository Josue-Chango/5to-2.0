...
<head>
    ...
    <title>${tipo == null ? 'Nuevo' : 'Editar'} Tipo de Habitación - HotelGestión</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/tipoHabitacion"><i class="fas fa-layer-group"></i>Tipos</a></li>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="page-header">
                <h1>
                    <i class="fas ${tipo == null ? 'fa-plus-circle' : 'fa-edit'} me-2" style="color: var(--gold);"></i>
                    ${tipo == null ? 'Nuevo' : 'Editar'} Tipo de Habitación
                </h1>
                <p class="subtitle">${tipo == null ? 'Registre un nuevo tipo de habitación' : 'Modifique los datos del tipo de habitación'}</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-layer-group me-2"></i> Datos del Tipo
                        </div>
                        <div class="card-body p-4">
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    <label class="form-label"><i class="fas fa-tag me-1" style="color: var(--gold);"></i>Nombre</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-users me-1" style="color: var(--gold);"></i>Capacidad</label>
                                        <input type="number" name="capacidad" class="form-control" value="${tipo.capacidad}" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-dollar-sign me-1" style="color: var(--gold);"></i>Precio Base</label>
                                        <input type="number" step="0.01" name="precioBase" class="form-control" value="${tipo.precioBase}" required>
                                    </div>
                                </div>
                                <div class="mt-4 d-flex gap-2">
                                    ...
                                    <a href="${pageContext.request.contextPath}/tipoHabitacion" class="btn btn-secondary">

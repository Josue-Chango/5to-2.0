...
<head>
    ...
    <title>Clientes - HotelGestión</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-users me-2" style="color: var(--gold);"></i>Clientes</h1>
                    <p class="subtitle">Registro de huéspedes del hotel</p>
                </div>
            ...
            <div class="table-container">
                <div class="search-box mb-3">
                    ...
                    <input type="text" class="form-control" id="tableSearch" placeholder="Buscar clientes..." onkeyup="filterTable()">
                </div>
                    ...
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                            <c:forEach var="c" items="${clientes}">
                                <tr>
                                    <td><span class="fw-semibold">${c.idCliente}</span></td>
                                    <td><i class="fas fa-user me-1 text-muted"></i>${c.nombre}</td>
                                    <td>${c.apellido}</td>
                                    <td><span class="badge bg-secondary">${c.dni}</span></td>
                                    <td><i class="fas fa-phone me-1 text-muted"></i>${c.telefono}</td>
                                    <td><i class="fas fa-envelope me-1 text-muted"></i>${c.email}</td>
                                    <td><i class="fas fa-map-marker-alt me-1 text-muted"></i>${c.direccion}</td>
                                    <td class="text-center">
                                        <a href="?action=editar&id=${c.idCliente}" class="btn btn-sm btn-warning me-1" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)" onclick="confirmDelete(${c.idCliente}, '${c.nombre} ${c.apellido}')" class="btn btn-sm btn-danger" title="Eliminar">

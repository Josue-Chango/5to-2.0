...
<head>
    ...
    <title>Tipos de Habitación - HotelGestión</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-layer-group me-2" style="color: var(--gold);"></i>Tipos de Habitación</h1>
                    <p class="subtitle">Categorías y tarifas del hotel</p>
                </div>
            ...
            <div class="table-container">
                <div class="search-box mb-3">
                    ...
                    <input type="text" class="form-control" id="tableSearch" placeholder="Buscar tipos..." onkeyup="filterTable()">
                </div>
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        <c:forEach var="t" items="${tipos}">
                            <tr>
                                <td><span class="fw-semibold">${t.idTipo}</span></td>
                                <td><i class="fas fa-tag me-1 text-muted"></i>${t.nombre}</td>
                                <td>${t.descripcion}</td>
                                <td><i class="fas fa-users me-1 text-muted"></i>${t.capacidad} pers.</td>
                                <td><span class="fw-semibold" style="color: var(--gold);">$${t.precioBase}</span></td>
                                <td class="text-center">
                                    <a href="?action=editar&id=${t.idTipo}" class="btn btn-sm btn-warning me-1" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="confirmDelete(${t.idTipo}, '${t.nombre}')" class="btn btn-sm btn-danger" title="Eliminar">
                ...
                <c:if test="${empty tipos}">
                    <div class="text-center py-4 text-muted">
                        <i class="fas fa-layer-group fa-3x mb-3" style="color: var(--gold);"></i>
                        <p class="mb-0">No hay tipos de habitación registrados</p>
                    </div>
                </c:if>
            </div>
        </div>

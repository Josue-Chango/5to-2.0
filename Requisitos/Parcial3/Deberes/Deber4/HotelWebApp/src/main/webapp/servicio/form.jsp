...
<head>
    ...
    <title>${servicio == null ? 'Nuevo' : 'Editar'} Servicio - HotelGestión</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="page-header">
                <h1>
                    <i class="fas ${servicio == null ? 'fa-plus-circle' : 'fa-edit'} me-2" style="color: var(--gold);"></i>
                    ${servicio == null ? 'Nuevo' : 'Editar'} Servicio
                </h1>
                <p class="subtitle">${servicio == null ? 'Registre un nuevo servicio adicional' : 'Modifique los datos del servicio'}</p>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    <label class="form-label"><i class="fas fa-dollar-sign me-1" style="color: var(--gold);"></i>Precio</label>
                                ...
                                <div class="mt-4 d-flex gap-2">
                                    ...
                                    <a href="${pageContext.request.contextPath}/servicio" class="btn btn-secondary">

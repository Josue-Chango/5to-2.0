...
<head>
    ...
    <title>Servicios - HotelGestión</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/servicio"><i class="fas fa-concierge-bell"></i>Servicios</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-concierge-bell me-2" style="color: var(--gold);"></i>Servicios</h1>
                    <p class="subtitle">Servicios adicionales del hotel</p>
                </div>
            ...
            <div class="table-container">
                <div class="search-box mb-3">
                    ...
                    <input type="text" class="form-control" id="tableSearch" placeholder="Buscar servicios..." onkeyup="filterTable()">
                </div>
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        <c:forEach var="s" items="${servicios}">
                            <tr>
                                <td><span class="fw-semibold">${s.idServicio}</span></td>
                                <td><i class="fas fa-tag me-1 text-muted"></i>${s.nombre}</td>
                                <td>${s.descripcion}</td>
                                <td><span class="fw-semibold" style="color: var(--gold);">$${s.precio}</span></td>
                                <td class="text-center">
                                    <a href="?action=editar&id=${s.idServicio}" class="btn btn-sm btn-warning me-1" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="confirmDelete(${s.idServicio}, '${s.nombre}')" class="btn btn-sm btn-danger" title="Eliminar">

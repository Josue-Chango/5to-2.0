...
Se seleccion\'o el \textbf{sello institucional de la Universidad de las Fuerzas Armadas ESPE}, ubicado en la plazoleta frente a la biblioteca de la universidad. Este elemento es representativo de la identidad institucional y posee caracter\'isticas geom\'etricas adecuadas para un escaneo por fotogrametr\'ia: superficies con relieve, detalles grabados, bordes definidos y un tama\~no accesible que permite una captura completa desde varios \'angulos.
...
\begin{enumerate}
    ...
    \item Se export\'o el modelo en formato \texttt{.glb} y \texttt{.obj} para su posterior edici\'on en Blender.
\end{enumerate}
...
El modelo 3D obtenido constituye una representaci\'on digital v\'alida del sello institucional. Si bien no alcanza el nivel de detalle de un escaneo profesional con equipo especializado, cumple satisfactoriamente con el prop\'osito acad\'emico de la actividad, demostrando la aplicaci\'on pr\'actica de la fotogrametr\'a como t\'ecnica de digitalizaci\'on 3D.
...
\begin{itemize}
    \item La fotogrametr\'a con Polycam demostr\'o ser una t\'ecnica accesible y efectiva para la digitalizaci\'on 3D de elementos representativos del campus universitario, permitiendo obtener un modelo tridimensional del sello de la ESPE con un nivel de detalle aceptable para fines acad\'emicos.
    \item La iluminaci\'on natural y los m\'ultiples \'angulos de captura fueron factores determinantes en la calidad del modelo final, reafirmando la importancia de las condiciones controladas en todo proceso de fotogrametr\'a.
    \item El posprocesamiento en Blender result\'o necesario para refinar la malla y corregir artefactos, lo que evidencia que la fotogrametr\'a automatizada requiere una etapa de edici\'on manual para obtener resultados \'optimos.
    \item El flujo de trabajo empleado (Polycam $\rightarrow$ Blender $\rightarrow$ archivo .blend/.glb) constituye un pipeline completo y replicable para futuros proyectos de digitalizaci\'on 3D en el \'ambito acad\'emico.
\end{itemize}
